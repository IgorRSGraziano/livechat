defmodule LivechatWeb.UserAuthTest do
  use LivechatWeb.ConnCase, async: true

  alias Livechat.Accounts
  alias Livechat.Accounts.Scope
  alias LivechatWeb.UserAuth

  import Livechat.AccountsFixtures

  @remember_me_cookie "_livechat_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, LivechatWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
